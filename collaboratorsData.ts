...
export const INITIAL_COLLABORATORS: Collaborator[] = [
  ...
  },
  {
    ...
    escale: 'BOD',
    service: 'PHMR',
    poste: 'Agent accompagnement PHMR',
    coefficient: '175',
    matricule: 'M22019',
    hireDate: '2022-10-05',
